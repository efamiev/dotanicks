...
config :dotanicks_web, DotanicksWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "n3Q0EgHIsR8XwuJMsx2hoiDI4jQtLH+j4tiibqdMPDdcwLQ8QOVqHCIpbZJ4SxNt",
  watchers: [
    esbuild: {Esbuild, :install_and_run, [:dotanicks_web, ~w(--sourcemap=inline --watch)]},
    tailwind: {Tailwind, :install_and_run, [:dotanicks_web, ~w(--watch)]}
  ]
...
config :dotanicks_web, DotanicksWeb.Endpoint,
  live_reload: [
    patterns: [
      ...
      ~r"priv/gettext/.*(po)$",
      ~r"lib/dotanicks_web/(controllers|live|components)/.*(ex|heex)$"
    ]
  ]
